                                            ...
                                            <div class="mu-latest-course-single">
                                                <figure class="mu-latest-course-img">
                                                    ...
                                                    <figcaption class="mu-latest-course-imgcaption">
                                                        <a href="{{route('front.coursedetails',[$cats->id,$course->id])}}">{{$course->name}}</a>
                                                ...
                                                <div class="mu-latest-course-single-content">
                                                    ...
                                                    <div class="mu-latest-course-single-contbottom">
                                                        <button class="btn btn-warning" ><a href="{{route('front.coursedetails',[$cats->id,$course->id])}}">More Details</a></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @foreach($lacourses as $course)
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="{{route('front.coursedetails',[$cats->id,$course->id])}}">
                                                        <img class="media-object" src="{{asset('uploads/courses/'.$course->img)}}" alt="img">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <h4 class="media-heading"><a href="{{route('front.coursedetails',[$cats->id,$course->id])}}">{{$course->name}}</a></h4>
