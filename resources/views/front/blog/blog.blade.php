                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <article class="mu-blog-single-item " style="width: 450px;height: 450px;background-color: #FFFFFF">
                                            <figure class="mu-blog-single-img">
                                                <a href="{{route('front.blogdetails',[$blog->id])}}"><img src="{{asset('uploads/blogs/'.$blog->img)}}" alt="img"></a>
                                                <figcaption class="mu-blog-caption">
                                                    <h3 class=" text-sm-center mt-1"><a href="{{route('front.blogdetails',[$blog->id])}}">{{$blog->name}}</a></h3>
                                                </figcaption>
                                            </figure>
                                            <div class="mu-blog-description">
                                                <p>EduTec Learning Center</p>
                                                <a class="mu-read-more-btn" href="{{route('front.blogdetails',$blog->id)}}">Read More</a>
                                            </div>
                                        </article>
                                    </div>
                                    @endforeach
