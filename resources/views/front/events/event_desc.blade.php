                                    ...
                                    <div class="col-md-12">
                                        <div class="mu-latest-course-single">
                                            <figure class="mu-latest-course-img">
                                                <a href="#"><img src="{{asset('uploads/events/'.$events->img)}}" alt="img"></a>
                                                <figcaption class="mu-latest-course-imgcaption">
                                                    <a href="#">{{$events->name}}</a>
                                                    <span><i class="fa fa-clock-o"></i>{{$events->duration}}</span>
                                                </figcaption>
                                            </figure>
                                            ...
                                            <div class="mu-latest-course-single-content pt-3 ">
                                                ...
                                                <ul class="text-start fw-bold text-start list-group">
                                                    <li class="text-start fw-bold @if (App::getLocale() == 'en')text-start @else text-end @endif" style="padding-left: 100px; padding: 20px;">{!! nl2br($events->desc) !!}</li>
                                                ...
                                                <ul class="text-start fw-bold text-start">
                                                    <li class="text-start fw-bold @if (App::getLocale() == 'en')text-start @else text-end @endif" style="padding-left: 100px;padding: 20px;">{!! nl2br($events->aim_course) !!}</li>
