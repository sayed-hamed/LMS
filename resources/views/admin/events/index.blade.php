...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0"> {{trans('main_trans.Events')}}
                </h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">{{trans('main_trans.Events')}}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <a href="{{route('admin.event.create')}}" class="btn btn-lg btn-success justify-content-center  mt-10 bg-gradient ml-1" style="margin-left: 260px">{{trans('main_trans.Add Events')}}</a>
                            ...
                            @foreach($courses as $course)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('admin.event.edit',$course->id)}}" class="btn btn-sm btn-info m-1">{{trans('main_trans.Edit')}}</a>


                                        <a href="{{route('admin.event.delete',$course->id)}}" type="button" class="btn btn-sm btn-danger m-1">{{trans('main_trans.Delete')}}</a>
