...
@section('content')
    ...
    <div class="container d-flex justify-content-center mt-10">
        <form class="justify-content-between" method="post" action="{{route('admin.event.update')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group mt-4" style="width: 800px;display: block ">
                ...
                <input type="file" class="form-control-file mt-2" value="{{asset('uploads/events/'.$course->img)}}" name="img" id=""  placeholder="">
            </div>
