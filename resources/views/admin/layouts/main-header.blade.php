 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="index.html"><img src="{{asset('assets/images/logo.png')}}" alt=""></a>
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{asset('assets/images/logo1.png')}}" alt="avatar">
                    </a>
...
{{--                                    <span>{{Auth::User()->email}}</span>--}}
                        ...
                        <a class="dropdown-item" href="{{route('admin.home')}}"><i class="text-info ti-settings"></i>Settings</a>
