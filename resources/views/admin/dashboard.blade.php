                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">Trainers</p>
                                    <h4>{{\App\Trainers::count()}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
            ...
            <div class="row">
                <div class="col-xl-4 mb-30">
                    <div class="card card-statistics h-100">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Center summary</h5>
                            <h4>Center Statistics </h4>
                        </div>
