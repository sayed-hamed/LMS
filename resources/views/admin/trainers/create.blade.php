...
@section('content')
    ...
    <div class="container d-flex justify-content-center mt-10">
        <form class="justify-content-between" method="post" action="{{route('admin.trainer.store')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group mt-4" style="width: 800px;display: block ">
                <label for="exampleInputEmail1">Phone in English</label>
                <input type="text" class="form-control mt-2" name="phone" id="exampleInputEmail1"  placeholder="Enter Your Phone">
            </div>
            ...
            <div class="form-group mt-4" style="width: 800px;display: block ">
                ...
                <input type="text" class="form-control mt-2" name="desc" id="exampleInputEmail1"  placeholder="Enter Your Description" >
            </div>

            <div class="form-group mt-4" style="width: 800px;display: block ">
                <label for="exampleInputEmail1">Description in Arabic</label>
                <input type="text" class="form-control mt-2" name="desc_ar" id="exampleInputEmail1"  placeholder="Enter Your Description" >
            </div>
